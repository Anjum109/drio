    ...
    return (
        <div className='mt-12'>
            <div className="flex justify-between w-[360px]">
                <p className="text-[#DA3545] text-[14px] font-[500]">Upload image of your Restaurant *</p>
                <Image src={info} alt="info" className="w-[16px] h-[16px]" />
            </div>
            <button className='mt-5' onClick={handleUploadClick}>
                <div className='w-[120px] h-[120px] bg-[#E5E5E5]'>
